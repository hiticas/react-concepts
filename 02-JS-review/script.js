...
const sumary = `book: ${title} by ${author} (${getYear(publicationDate)})`;
console.log(sumary);
...
const hasEnglishTranslation = book.translations.english || "NOT TRANSLATED";
console.log(hasEnglishTranslation);
